...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/Home/zlr/Code/Hazydataset/NH-HAZE/')
    ...
    args.model_save_dir = os.path.join('results/', args.model_name, 'NH/', current_time)
